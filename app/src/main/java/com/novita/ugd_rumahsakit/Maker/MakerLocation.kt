package com.novita.ugd_rumahsakit.Maker
...
import kotlinx.android.synthetic.main.activity_maker_location.*
...
class MakerLocation : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maker_location)
...
//        val geoPoint1 = GeoPoint1(-7.783437, 110.390938)
//        mapview.setMultiTouchControls(true)
//        mapview.controller.animateTo(geoPoint)
//        mapview.setTileSource(TileSourceFactory.DEFAULT_TILE_SOURCE)
//        mapview.zoomController.setVisibility(CustomZoomButtonsController.Visibility.NEVER)
